...
public class DataTypes {
	...
	public static void main(String[] args) {
		 ...
		 *             ii. Integral value-
		 * Integers- byte, short, interger & long 
		 ...
		 * range=-2147483648 to 2147483647 i.e -2^31 to
		 * 2^31-1
		 */
		int i = 2147483647;
		int i1 = 3423412;
		 ...
		 * range=-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807 i.e -2^63 to 2^63-1
		 */
		long l = 2147483;
		long l2 = 3423412;
		long l3 = 2147483648l;
		...
		//int i4= 100.43;  gives error as float/double can save both float and interger values but integer can notsave float value
		// long lon2= 9223372036854775808l; // gives error as value is out of memory
		//===========================================================================================//
		 ...
		 * char is always declared in single quotes
